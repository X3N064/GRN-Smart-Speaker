...
describe('util - ssml', function() {
  ...
  describe('audioTag', function() {
    it('returns a string', function() {
      const output = ssml.audioTag('https://storage.com/audio.ogg');
      expect(output).to.be.a('string');
    });

    it('returns a ssml audio tag', function() {
      const output = ssml.audioTag('https://storage.com/audio.ogg');
      expect(output).to.eql('<audio src="https://storage.com/audio.ogg"/>');
    });
  });
});
