 ...
 */
/**
 * @file Add built in plug and play web framework support for lambda HTTP Proxy API gateway
 */
...
export declare class Lambda implements Framework<LambdaHandler> {
    handle(standard: StandardHandler): (event: JsonObject, context: Context, callback: Callback) => Promise<void>;
