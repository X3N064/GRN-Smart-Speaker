...
exports.CollectionBrowse = void 0;
...
class CollectionBrowse {
    /** @hidden */
    constructor(input = {}) {
        const { imageFill = Schema.ImageFill.Unspecified, items = [], } = input;
        this.imageFill = imageFill;
        this.items = items;
    }
}
exports.CollectionBrowse = CollectionBrowse;
//# sourceMappingURL=collectionBrowse.js.map